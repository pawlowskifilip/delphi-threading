...
begin
  ...
  Writeln(Format('Scenariusz A zakonczony w %d ms. Znaleziono %d bledów.',
...
begin
  ...
  Writeln(Format('Scenariusz B (%d watkow) zakonczony w %d ms. Znaleziono %d bledów.',
...
begin
  ...
  Writeln(Format('Scenariusz C (%d watkow) zakonczony w %d ms. Znaleziono %d bledów.',
    [ALiczbaWatkow, Stoper.ElapsedMilliseconds, FListaBledow.Count]));
...
begin
  ...
  WriteLn(Format('Najbardziej optymalna liczba watków dla scenariusza B: %d watkow (Czas egzekucji: %d ms)',
